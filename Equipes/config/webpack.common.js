...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      "@/mock": pathtoresolve.join(paths.src, "mock"),
      "@/components": pathtoresolve.join(paths.src, "components"),
      "@/ui": pathtoresolve.join(paths.src, "components/ui"),
      "@/views": pathtoresolve.join(paths.src, "views"),
      '@/styles': pathtoresolve.resolve(paths.src, 'styles'),
    },
  },
